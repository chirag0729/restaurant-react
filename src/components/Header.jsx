...
//                     <p className='text-headingColor text-xl font-bold'> CR </p>
//                 </Link>
...
//                     <div className='relative flex items-center justify-center' ><MdShoppingBasket className='text-textColor text-2xl cursor-pointer' />
...
//                                 {
//                                     user && user.email === "patilchirag1432@gmail.com" && (<Link to={'/createItem'}>
//                                         <p className="px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base" onClick={() => setIsMenu(false)} > New Item <MdAdd /></p></Link>
//                                     )
//                                 }
...
//                             <p className="m-2 p-2 flex items-center justify-center bg-slate-200 gap-3 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base rounded-md" onClick={logout}> Logout <MdLogout /> </p>
//                         </div>
//                     )}
//                 </div>
//             </div>
